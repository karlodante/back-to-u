...
export class BootScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    // Cargar imagen del menú principal
    this.load.image("menu-bg", "assets/menu-bg.png");

    // Configuración de spritesheets
    const frameConfig = { frameWidth: 32, frameHeight: 32 };
    this.load.spritesheet('wara_idle', 'assets_karlo/Wara REPOSO PNG.png', frameConfig);
    this.load.spritesheet('wara_walk', 'assets_karlo/Wara CAMINATA PNG.png', frameConfig);
    this.load.spritesheet('wara_run', 'assets_karlo/Wara CORRER PNG.png', frameConfig);
    this.load.spritesheet('wara_jump', 'assets_karlo/Wara SALTO PNG.png', frameConfig);
    this.load.spritesheet('wara_attack', 'assets_karlo/Wara ATACANDO PNG.png', frameConfig);
